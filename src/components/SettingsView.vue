  ...
  >
    ...
    <div class="flex-1 flex min-h-0 overflow-hidden">
      ...
      <div class="flex-1 overflow-y-auto min-h-0 px-5 pt-4 pb-5">
        ...
        <!-- ═══════════════ LANGUAGE SECTION ═══════════════ -->
        <section v-show="activeSectionId === 'language'" class="settings-section">
          <div class="section-header">
            <div class="section-icon">
              <svg
                width="12"
        ...
        <!-- ═══════════════ ACTIVATION SECTION ═══════════════ -->
        <section v-show="activeSectionId === 'activation'" class="settings-section">
          <div class="section-header">
            <div class="section-icon">
              <svg
                width="12"
        ...
        <section v-show="activeSectionId === 'transcription'" class="settings-section">
          <div class="section-header">
            <div class="section-icon">
              <svg
                width="12"
        ...
        <!-- ═══════════════ VOCABULARY SECTION ═══════════════ -->
        <section v-show="activeSectionId === 'vocabulary'" class="settings-section">
          <div class="section-header">
            <div class="section-icon">
              <svg
                width="12"
        ...
        <!-- ═══════════════ GENERAL SECTION ═══════════════ -->
        <section v-show="activeSectionId === 'general'" class="settings-section">
          <div class="section-header">
            <div class="section-icon">
              <svg
                width="12"
