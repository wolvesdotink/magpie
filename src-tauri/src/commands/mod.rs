...
// Whisper model commands + repair flow extracted to commands/models.rs.
// Settings + global-shortcut + launch-at-login extracted to
// commands/settings.rs.

// Correction model commands extracted to commands/correction_models.rs.
// Vocabulary commands extracted to commands/vocabulary.rs.
